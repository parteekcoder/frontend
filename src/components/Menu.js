...
function Menu({ scrollupmenu }) {
    ...
    return (
        <>
            <div className={"z-20 overflow-y-auto bg-white scrolling-touch max-w-full lg:max-w-xs lg:max-h-[calc(100vh-6rem)] lg:block lg:sticky lg:mr-0 scrollbar lg:top-[80px]"}>
