          ...
          data ? data.map((item, i) => {
            return (
              item.type==="Research Area"&&<div key={i} className='my-4 sm:mx-4 p-2'>
                <div className="w-full h-60 border-2 object-cover object-center rounded-lg shadow-md overflow-hidden">
                  <img src={item?.img} alt=" random imgee" className="w-full h-full object-cover object-center rounded-lg shadow-md hover:scale-110 duration-500" />
                </div>
                <div className="relative px-4 -mt-7 md:-mt-9">
                  <div className="max-w-fit mx-auto bg-white flex items-center justify-center py-2 px-4 md:px-6 md:py-3.5 rounded-lg shadow-lg">
